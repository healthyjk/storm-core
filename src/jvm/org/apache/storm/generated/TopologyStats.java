...
public class TopologyStats implements org.apache.thrift.TBase<TopologyStats, TopologyStats._Fields>, java.io.Serializable, Cloneable, Comparable<TopologyStats> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_emitted = new HashMap<String,Long>(2*_map362.size);
                String _key363;
                long _val364;
                for (int _i365 = 0; _i365 < _map362.size; ++_i365)
                {
                  ...
                  struct.window_to_emitted.put(_key363, _val364);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_transferred = new HashMap<String,Long>(2*_map366.size);
                String _key367;
                long _val368;
                for (int _i369 = 0; _i369 < _map366.size; ++_i369)
                {
                  ...
                  struct.window_to_transferred.put(_key367, _val368);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map370.size);
                String _key371;
                double _val372;
                for (int _i373 = 0; _i373 < _map370.size; ++_i373)
                {
                  _key371 = iprot.readString();
                  _val372 = iprot.readDouble();
                  struct.window_to_complete_latencies_ms.put(_key371, _val372);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_acked = new HashMap<String,Long>(2*_map374.size);
                String _key375;
                long _val376;
                for (int _i377 = 0; _i377 < _map374.size; ++_i377)
                {
                  ...
                  struct.window_to_acked.put(_key375, _val376);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.window_to_failed = new HashMap<String,Long>(2*_map378.size);
                String _key379;
                long _val380;
                for (int _i381 = 0; _i381 < _map378.size; ++_i381)
                {
                  ...
                  struct.window_to_failed.put(_key379, _val380);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.window_to_emitted != null) {
        if (struct.is_set_window_to_emitted()) {
          oprot.writeFieldBegin(WINDOW_TO_EMITTED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter382 : struct.window_to_emitted.entrySet())
            {
              oprot.writeString(_iter382.getKey());
              oprot.writeI64(_iter382.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.window_to_transferred != null) {
        if (struct.is_set_window_to_transferred()) {
          oprot.writeFieldBegin(WINDOW_TO_TRANSFERRED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter383 : struct.window_to_transferred.entrySet())
            {
      ...
      if (struct.window_to_complete_latencies_ms != null) {
        if (struct.is_set_window_to_complete_latencies_ms()) {
          oprot.writeFieldBegin(WINDOW_TO_COMPLETE_LATENCIES_MS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Double> _iter384 : struct.window_to_complete_latencies_ms.entrySet())
            {
              oprot.writeString(_iter384.getKey());
              oprot.writeDouble(_iter384.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.window_to_acked != null) {
        if (struct.is_set_window_to_acked()) {
          oprot.writeFieldBegin(WINDOW_TO_ACKED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter385 : struct.window_to_acked.entrySet())
            {
      ...
      if (struct.window_to_failed != null) {
        if (struct.is_set_window_to_failed()) {
          oprot.writeFieldBegin(WINDOW_TO_FAILED_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Long> _iter386 : struct.window_to_failed.entrySet())
            {
  ...
  private static class TopologyStatsTupleScheme extends TupleScheme<TopologyStats> {
      ...
      if (struct.is_set_window_to_emitted()) {
        {
          ...
          for (Map.Entry<String, Long> _iter387 : struct.window_to_emitted.entrySet())
          {
            oprot.writeString(_iter387.getKey());
            oprot.writeI64(_iter387.getValue());
          }
        }
      }
      if (struct.is_set_window_to_transferred()) {
        {
          ...
          for (Map.Entry<String, Long> _iter388 : struct.window_to_transferred.entrySet())
          {
      ...
      if (struct.is_set_window_to_complete_latencies_ms()) {
        {
          ...
          for (Map.Entry<String, Double> _iter389 : struct.window_to_complete_latencies_ms.entrySet())
          {
            oprot.writeString(_iter389.getKey());
            oprot.writeDouble(_iter389.getValue());
          }
        }
      }
      if (struct.is_set_window_to_acked()) {
        {
          ...
          for (Map.Entry<String, Long> _iter390 : struct.window_to_acked.entrySet())
          {
            oprot.writeString(_iter390.getKey());
            oprot.writeI64(_iter390.getValue());
          }
        }
      }
      if (struct.is_set_window_to_failed()) {
        {
          ...
          for (Map.Entry<String, Long> _iter391 : struct.window_to_failed.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TopologyStats struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map392 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_emitted = new HashMap<String,Long>(2*_map392.size);
          String _key393;
          long _val394;
          for (int _i395 = 0; _i395 < _map392.size; ++_i395)
          {
            ...
            struct.window_to_emitted.put(_key393, _val394);
          }
        }
        struct.set_window_to_emitted_isSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map396 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.window_to_transferred = new HashMap<String,Long>(2*_map396.size);
          String _key397;
          long _val398;
          for (int _i399 = 0; _i399 < _map396.size; ++_i399)
          {
            ...
            struct.window_to_transferred.put(_key397, _val398);
          }
        }
        struct.set_window_to_transferred_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map400 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.DOUBLE, iprot.readI32());
          struct.window_to_complete_latencies_ms = new HashMap<String,Double>(2*_map400.size);
          String _key401;
          double _val402;
          for (int _i403 = 0; _i403 < _map400.size; ++_i403)
          {
            ...
            struct.window_to_complete_latencies_ms.put(_key401, _val402);
          }
        }
        struct.set_window_to_complete_latencies_ms_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.window_to_acked = new HashMap<String,Long>(2*_map404.size);
          String _key405;
          long _val406;
          for (int _i407 = 0; _i407 < _map404.size; ++_i407)
          {
            ...
            struct.window_to_acked.put(_key405, _val406);
          }
        }
        struct.set_window_to_acked_isSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.window_to_failed = new HashMap<String,Long>(2*_map408.size);
          String _key409;
          long _val410;
          for (int _i411 = 0; _i411 < _map408.size; ++_i411)
          {
            ...
            struct.window_to_failed.put(_key409, _val410);
          }
        }
        struct.set_window_to_failed_isSet(true);
      }
